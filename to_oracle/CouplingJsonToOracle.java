...
public class CouplingJsonToOracle {
    public static void main(String[] args) {
        String jsonFile = "data/Coupling.json";
        String dbUrl = "jdbc:oracle:thin:@localhost:1521/XEPDB1";
        String dbUser = "TSUBAKIAPP";
        String dbPassword = "tsubaki1234";

        String insertSQL = "INSERT INTO COUPLING_JSON VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            for (JsonElement elem : products) {
                ...
                pstmt.setDouble(8, getSafeDouble(spec, "rated_torque_nm"));
                pstmt.setString(9, getSafe(spec, "bore_range_mm"));
                pstmt.setString(10, getSafe(spec, "coupling_type"));
                pstmt.setString(11, getSafe(spec, "material"));
                pstmt.setString(12, getSafe(spec, "temperature_range"));
                pstmt.setInt(13, getSafeInt(spec, "max_rpm"));
            ...
            System.out.println("✅ " + count + "건 삽입 완료 (Coupling)");
